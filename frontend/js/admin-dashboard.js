...
async function loadOrganizers() {
    try {
        const response = await fetch(`${API_CONFIG.BASE_URL}/admin/organizers`);
...
async function approveOrganizer(username) {
    ...
    try {
        const response = await fetch(`${API_CONFIG.BASE_URL}/admin/approve-organizer/${username}`, {
            method: 'POST',
            headers: {
...
async function rejectOrganizer(username) {
    ...
    try {
        const response = await fetch(`${API_CONFIG.BASE_URL}/admin/reject-organizer/${username}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
