...
async function loadDashboard() {
    try {
        const response = await fetch(`http://localhost:5000/organizers/${loggedInOrganizer.username}/events`);
...
async function viewBookings(eventId, eventName) {
    try {
        const response = await fetch(`http://localhost:5000/events/${eventId}/bookings`);
